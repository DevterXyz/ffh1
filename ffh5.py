...
os.system("clear")
print ("\033[35m                     ╔════════════════════════════════════╗")
print ("\033[35m                     ║\033[34m  ╔═╗╔═╗╦╔═╦ ╦╦═╗╔═╗\033[31m  ╦╔╗ ╦  ╦╔═╗\033[35m   ║")
print ("\033[35m                     ║\033[34m  ╚═╗╠═╣╠╩╗║ ║╠╦╝╠═╣\033[31m  ║╠╩╗║  ║╚═╗\033[35m   ║")
print ("\033[35m                     ║\033[34m  ╚═╝╩ ╩╩ ╩╚═╝╩╚═╩ ╩\033[31m  ╩╚═╝╩═╝╩╚═╝ \033[35m  ║")
print ("\033[35m                     ╚════════════════════════════════════╝")
print ("\033[31m                              ╔══════════════════╗")
print ("\033[31m                              ║ \033[35m  TOOLS BY \033[34mZ𝕏Z  \033[31m ║") 
print ("\033[31m                              ╚══════════════════╝")
print ("\033[31m                      ╔════════════════════════════════════╗")
print ("\033[31m                      ║    \033[37m   SUBSCRIBE MY \033[31mYOUTUBE         \033[31m║")
print ("\033[31m                      ╚════════════════╦╦═════════════════╝")
ip = str(input("\033[96m                         \033[34mAttack To IP║║\033[35m \033[91m"))           
port = int(input("\033[96m                         \033[34mAttack To Port ║║\033[35m \033[91m"))
